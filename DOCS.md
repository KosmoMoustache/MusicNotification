...
- "key": the sound event identifier of the track
  ...
  - "customId": (Optional) Custom identifier for the track. e.g. when the music if from an ambient music sound event, see [sounds.json](./common/src/resources/assets/musicnotification/sounds.json) and the vanilla sounds.json that can be found [here](https://mcasset.cloud/)  
