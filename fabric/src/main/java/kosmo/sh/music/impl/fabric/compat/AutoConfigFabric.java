package kosmo.sh.music.impl.fabric.compat;

import me.shedaniel.autoconfig.ConfigData;
import me.shedaniel.autoconfig.annotation.Config;
import me.shedaniel.autoconfig.annotation.ConfigEntry;
import kosmo.sh.music.impl.ClientMusic;
import kosmo.sh.music.impl.config.ConfigHolder.DisableToastSound;

import java.util.List;

@Config(name = ClientMusic.MOD_ID)
public class AutoConfigFabric implements ConfigData {
